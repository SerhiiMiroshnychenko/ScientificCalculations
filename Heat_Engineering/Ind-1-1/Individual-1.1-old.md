...
# 1. Вхідні дані з таблиці 1.1 для варіанту
q = ...  # тепловий потік, кВт/м²
d = .../1000  # зовнішній діаметр труби, м
d1 = .../1000  # внутрішній діаметр труби, м
n_90 = ...  # кількість поворотів на 90°
n_180 = ...  # кількість поворотів на 180°
t_in = ...  # температура води на вході, °С
P_wat = ...  # тиск води в цеху, МПа
material = "..." 
...
```
    ...
    Cell In[2], line 9
          7 # 1. Вхідні дані з таблиці 1.1 для варіанту 25
          8 q = ...  # тепловий потік, кВт/м²
    ----> 9 d = .../1000  # зовнішній діаметр труби, м
         10 d1 = .../1000  # внутрішній діаметр труби, м
         11 n_90 = ...  # кількість поворотів на 90°
