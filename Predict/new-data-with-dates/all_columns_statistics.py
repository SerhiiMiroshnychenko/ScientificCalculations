...
def load_data(file_path, group_column='is_successful'):
    ...
    try:
        ...
        print(f"Додано числову колонку 'create_date_months': місяці від {min_date}")
    except Exception as e:
        print(f"Помилка при обробці create_date: {e}")
    ...
    if 'day_of_week' in df.columns:
        ...
        print(f"Додано числову колонку 'day_of_week_num': дні тижня (1-7)")
    ...
    if 'month' in df.columns:
        ...
        print(f"Додано числову колонку 'month_num': місяці (1-12)")
    ...
    if 'quarter' in df.columns:
        ...
        print(f"Додано числову колонку 'quarter_num': квартали (1-4)")
...
if __name__ == "__main__":
    ...
    FILE_PATH = 'cleanest_data.csv'  # Шлях до файлу
