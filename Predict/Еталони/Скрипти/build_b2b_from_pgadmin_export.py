...
INPUT_CSV = Path(r"D:\PROJECTs\MY\ScientificCalculations\SC\ScientificCalculations\Predict\Еталони\Дані\db5.csv")
OUTPUT_CSV = Path(r"D:\PROJECTs\MY\ScientificCalculations\SC\ScientificCalculations\Predict\Еталони\Дані\db5_for_ml.csv")
