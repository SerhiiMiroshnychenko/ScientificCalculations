...
# === Параметри ===
DATA_PATH = r"preprocessed_data2.csv"
RESULTS_DIR = "compare_feature_combinations"
RANDOM_STATE = 42
...
AUC_MIN = 0.9766
# RFE — темно-блакитна
aucpr_df_rfe_12_24 = aucpr_df_rfe[(aucpr_df_rfe['n_features'] >= 12) & (aucpr_df_rfe['n_features'] <= 24) & (aucpr_df_rfe['aucpr'] >= AUC_MIN)]
...
# Greedy — зелена
aucpr_df_greedy_12_24 = aucpr_df_greedy[(aucpr_df_greedy['n_features'] >= 12) & (aucpr_df_greedy['n_features'] <= 24) & (aucpr_df_greedy['aucpr'] >= AUC_MIN)]
...
aucpr_df_xgb_12_24 = aucpr_df_xgb[(aucpr_df_xgb['n_features'] >= 12) & (aucpr_df_xgb['n_features'] <= 24) & (aucpr_df_xgb['aucpr'] >= AUC_MIN)]
...
aucpr_df_backward_12_24 = aucpr_df_backward[(aucpr_df_backward['n_features'] >= 12) & (aucpr_df_backward['n_features'] <= 24) & (aucpr_df_backward['aucpr'] >= AUC_MIN)]
...
# Boruta — червоний
aucpr_df_boruta_12_24 = aucpr_df_boruta[(aucpr_df_boruta['n_features'] >= 12) & (aucpr_df_boruta['n_features'] <= 24) & (aucpr_df_boruta['aucpr'] >= AUC_MIN)]
