...
При автоматизації керування ресурсами підприємства одне з найважливіших питань - 
контроль кількості продукції на складах та передбачення її майбутньої кількості.
Це необхідно для своєчасного виготовлення продукції та, за необхідності, закупки 
компонентів для забезпечення виробничого процесу.

Основний шлях для передбачення майбутньої кількості продукції - відстежувати 
замовлення на відповідні товари та їх відпуск зі складу. Для оперативного реагування 
на створені, але ще не погоджені, замовлення постає задача прогнозування їх успішності
спираючись на історичні дані ERP системи.

Важливим етапом для розуміння історичних даних є їх статистичний аналіз. 
Ми зібрали історичні дані за період 2017-2025 років для 7849 клієнтів у B2B-сегменті
що охоплює 86794 замовлення з яких 32031 класифіковано як неуспішні та 54763 як успішні. 
Для проведення статистичного аналізу відібрано 19 числових характеристик замовлень.

## Статистична модель

Нижче наведено реалізацію статистичної моделі для аналізу історичних даних та побудови прогнозів
щодо успішності створених замовлень
...
Результати роботи статистичної моделі представлено в наступних логах:
```text
================================================================================
СТАТИСТИЧНА МОДЕЛЬ ПРОГНОЗУВАННЯ
Час запуску: 2025-06-09 09:15:14
================================================================================
...
## Вимоги до статті
Спираючись на отримані дані ми пишемо наукову статтю за спеціальністю
151 Автоматизація та комп’ютерно-інтегровані технології
Назва статті: "Багатофакторний статистичний аналіз успішності замовлень як інструмент оптимізації автоматизованих систем керування ресурсами"
...
Стаття повинна бути представлена українською мовою. 

Таблиці подаються у книжній орієнтації.

Формули розміщуються по центру та нумеруються всередині статті, з номером, який розташовується праворуч від колонки. Після кожної формули слідує розділовий знак, а якщо вона супроводжується поясненням, то вони починаються на новому абзаці зі слова "де", без відступу. Нумерація формул, на які є посилання в тексті, вказується в дужках праворуч. Всі фізичні величини подаються в системі Міжнародної системи одиниць (СІ). Ціла та дробова частини чисел відокремлюються комою.

### Виклад основного матеріалу

У розділі "Виклад основного матеріалу" в нашому випадку повинно бути наступне:
1. Опис методології застосованої в реалізації статистичної моделі. 
   Розділ повинен містити наукові посилання на кожен метод чи статистичний тест використані в скрипті
   Повинен містити обґрунтування вибору саме такої методології та саме цих методів та тестів
2. Опис результатів отриманих в результаті дослідження
   Додати таблицю яка покаже для кожної ознаки її вагу та поріг
   Додати таблицю з основними статисничними показниками топ 3 найвпливовиших ознак 
   та топ 3 найневпливовиших для порівняння. Для кожної з цих ознак потрібно навести 
   середнє та медіану для групи "успішні" та групи "не успішні".
3. Кратко прокоментувати наведені візуалізації
   
### Висновки
Зробити висновки з отриманих результатів. Тут можливо також порівняти з результатами 
аналогічних досліджень з наукових статей.

## ЗАВДАННЯ
1. Проаналізувати надані матеріали
2. Знайти необхідні для написання статі наукові джерела (наукові джерела - тільки статті або книги з DOI посиланням)
   ЗВЕРТАЮ УВАГУ: ПОСИЛАТИСЯ ТІЛЬКИ НА НАУКОВІ СТАТТІ ЧЕРЕЗ DOI. Загальні посилання на Вікіпедію або сайти - НЕ ПРИПУСТИМІ!
3. Звернути увагу що джерела для обґрунтування методі та тестів з моделі - це окремо,
   а аналіз останніх досліджень і публікацій - які повинні стосуватися саме теми
   передбачення успішності замовлень та оптимізації автоматизованих систем керування ресурсами
4. Написати статтю згідно з вимогами та наведеними розробками та результатами
5. Обов'язково відмітити та описати розроблену методику та її особливості (автоматичний вибір типу тестів залежно від розподілу і тому подібне)
6. В статті будуть два рисунки (надані тобі як вкладення) та тільки згадані в файлі таблиці
7. Висновками статті повинно бути те що статистичні методи показали спроможність розділяти 
   замовлення на групи успішності але для більш точного передбачення потрібно застосувати більш
   досконалі моделі штучного навчання. Подальші дослідження будуть стосуватися вибору оптимальної
   моделі машинного навчання для цілей передбачення успішності замовлень
8. Стаття новинна бути написаною в науковому академічному стилі без використання спискових структур
