...
# Створюємо фіксовані позначки шкали
tick_positions = [5, 10, 15, 20]  # Фіксовані значення згідно з вимогами
tick_labels = [f"{val}" for val in tick_positions]
...
output_file_png = 'feature_importance_heatmap_RR.png'
output_file_svg = 'feature_importance_heatmap_RR.svg'
