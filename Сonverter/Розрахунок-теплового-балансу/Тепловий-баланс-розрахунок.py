...
variants = [
    {"M_чав": 71.8, "M_ст": 87.5, "M_шл": 16.0, "M_м.бр": 17.7, "M_м.ш": 1.3, "M_пил": 0.9, "Fe_vtr": 4.5,
     "t_чав": 1350, "t_ст": 1595},
    {"M_чав": 70.0, "M_ст": 85.0, "M_шл": 15.0, "M_м.бр": 5.0, "M_м.ш": 1.2, "M_пил": 0.85, "Fe_vtr": 4.2,
     "t_чав": 1335, "t_ст": 1630},
    {"M_чав": 72.0, "M_ст": 88.0, "M_шл": 16.5, "M_м.бр": 10.8, "M_м.ш": 1.3, "M_пил": 0.92, "Fe_vtr": 4.6,
     "t_чав": 1380, "t_ст": 1620},
    {"M_чав": 71.0, "M_ст": 86.5, "M_шл": 15.8, "M_м.бр": 7.9, "M_м.ш": 1.2, "M_пил": 0.87, "Fe_vtr": 4.3,
     "t_чав": 1360, "t_ст": 1620},
    {"M_чав": 70.5, "M_ст": 85.8, "M_шл": 15.5, "M_м.бр": 5.7, "M_м.ш": 1.2, "M_пил": 0.85, "Fe_vtr": 4.2,
     "t_чав": 1340, "t_ст": 1590},
    {"M_чав": 72.2, "M_ст": 88.2, "M_шл": 16.6, "M_м.бр": 8.1, "M_м.ш": 1.3, "M_пил": 0.93, "Fe_vtr": 4.7,
     "t_чав": 1390, "t_ст": 1620},
    {"M_чав": 70.8, "M_ст": 86.2, "M_шл": 15.7, "M_м.бр": 8.5, "M_м.ш": 1.2, "M_пил": 0.86, "Fe_vtr": 4.3,
     "t_чав": 1320, "t_ст": 1620},
    {"M_чав": 71.5, "M_ст": 87.0, "M_шл": 15.9, "M_м.бр": 7.2, "M_м.ш": 1.2, "M_пил": 0.88, "Fe_vtr": 4.4,
     "t_чав": 1370, "t_ст": 1600},
    {"M_чав": 71.2, "M_ст": 86.7, "M_шл": 15.8, "M_м.бр": 9.3, "M_м.ш": 1.2, "M_пил": 0.87, "Fe_vtr": 4.3,
     "t_чав": 1380, "t_ст": 1620},
    {"M_чав": 70.9, "M_ст": 86.3, "M_шл": 15.6, "M_м.бр": 9.5, "M_м.ш": 1.2, "M_пил": 0.86, "Fe_vtr": 4.3,
     "t_чав": 1380, "t_ст": 1590},
    {"M_чав": 70.0, "M_ст": 85.0, "M_шл": 15.0, "M_м.бр": 1.8, "M_м.ш": 1.2, "M_пил": 0.85, "Fe_vtr": 4.2,
     "t_чав": 1300, "t_ст": 1590},
    {"M_чав": 71.7, "M_ст": 87.7, "M_шл": 16.1, "M_м.бр": 7.7, "M_м.ш": 1.3, "M_пил": 0.91, "Fe_vtr": 4.6,
     "t_чав": 1370, "t_ст": 1610},
    {"M_чав": 70.2, "M_ст": 85.2, "M_шл": 15.1, "M_м.бр": 0.9, "M_м.ш": 1.2, "M_пил": 0.85, "Fe_vtr": 4.2,
     "t_чав": 1350, "t_ст": 1625},
    {"M_чав": 70.6, "M_ст": 85.6, "M_шл": 15.3, "M_м.бр": 1.3, "M_м.ш": 1.2, "M_пил": 0.85, "Fe_vtr": 4.2,
     "t_чав": 1300, "t_ст": 1600},
    {"M_чав": 71.3, "M_ст": 86.8, "M_шл": 15.9, "M_м.бр": 9.6, "M_м.ш": 1.2, "M_пил": 0.87, "Fe_vtr": 4.3,
     "t_чав": 1380, "t_ст": 1620},
]
...
Q_shlak_val = Q_shlak(selected_variant["M_шл"])
...
T_st = selected_variant["t_ст"] + 273  # Температура сталі в К
T_chav = selected_variant["t_чав"] + 273  # Температура чавуну в К
Q_gases_val = Q_gases(V_gi, T_st, T_chav, gas_coefs)

# Розрахунок тепла дисоціації оксидів
Q_okys_Fe_val = Q_okys_Fe(selected_variant["M_чав"], selected_variant["M_м.бр"])
...
print(f"Тепло дисоціації оксидів заліза: Q_окис^Fe = {Q_okys_Fe_val:.2f} кДж")
print(f"Тепло дисоціації карбонату кальцію: Q_окис^CaCO3 = {Q_okys_CaCO3_val:.2f} кДж")
...
def Q_vkv(Fe_vtr, M_pil, t_st):
    ...
    Кількість тепла в кДж
    """
    return (Fe_vtr - M_pil) * (VKV_COEFFICIENT_1 + VKV_COEFFICIENT_2 * t_st)
...
# Розрахунок тепла, що уносять викиди, корольки та виплески
Q_vkv_val = Q_vkv(selected_variant["Fe_vtr"], selected_variant["M_пил"], selected_variant["t_ст"])
...
def Q_vitr(Q_st_val, Q_shlak_val, Q_gases_val, Q_okys_Fe_val, Q_okys_CaCO3_val, Q_pil_val, Q_vkv_val, Q_vtr_val):
    """
    Розрахунок загальної витрати тепла.

    Параметри:
    Q_st_val - тепло рідкої сталі, кДж
    Q_shlak_val - тепло шлаку, кДж
    Q_gases_val - тепло конвертерних газів, кДж
    Q_okys_Fe_val - тепло дисоціації оксидів заліза, кДж
    Q_okys_CaCO3_val - тепло дисоціації карбонату кальцію, кДж
    Q_pil_val - тепло пилу, кДж
    Q_vkv_val - тепло викидів, корольків та виплесків, кДж
    Q_vtr_val - теплові втрати, кДж

    Повертає:
    Загальну витрату тепла в кДж
    """
    return Q_st_val + Q_shlak_val + Q_gases_val + Q_okys_Fe_val + Q_okys_CaCO3_val + Q_pil_val + Q_vkv_val + Q_vtr_val
...
# Обчислення загальної витрати тепла
# (використовуємо результати попередніх розрахунків)
Q_shlak_val = Q_shlak(selected_variant["M_шл"])
Q_vitr_val = Q_vitr(
    Q_st_val,
...
Q_vitr_val = Q_vitr(Q_st_val, Q_shlak_val, Q_gases_val, Q_okys_Fe_val, Q_okys_CaCO3_val, Q_pil_val, Q_vkv_val,
                    Q_vtr_val)
...
def calculate_cooling_additive(Q_balance_val, metal_type="брухт", t_st=None):
    """
    ...
    metal_type - тип охолоджуючої добавки ("брухт" або "руда")
    t_st - температура сталі, °C (потрібна для розрахунку маси брухту)
    ...
    if metal_type == "брухт" and t_st is not None:
        # Використовуємо формулу 5.80 з методики
        return Q_balance_val / (ST_COEFFICIENT_2 * t_st + ST_COEFFICIENT_1)
    else:
        # Приблизні значення для розрахунку
        c_ore = 0.9  # кДж/(кг·°C)
        delta_T_ore = 1400  # °C (різниця між температурою плавки і початковою температурою руди)
        return Q_balance_val / (c_ore * delta_T_ore)
...
if Q_balance_val < 0:
    ...
    # Використовуємо формулу 5.80 з методики для металобрухту
    m_scrap = calculate_cooling_additive(Q_balance_val, "брухт", selected_variant["t_ст"])
    # Використовуємо приблизну формулу для залізної руди
    m_ore = calculate_cooling_additive(Q_balance_val, "руда")
...
sink_labels = ['Тепло рідкої сталі', 'Тепло шлаку', 'Тепло конвертерних газів',
               'Тепло дисоціації оксидів заліза', 'Тепло дисоціації карбонату кальцію',
               'Тепло пилу', 'Тепло викидів, корольків, виплесків', 'Теплові втрати']
sink_values = [Q_st_val, Q_shlak_val, Q_gases_val, Q_okys_Fe_val,
               Q_okys_CaCO3_val, Q_pil_val, Q_vkv_val, Q_vtr_val]

# Розрахунок відсотків
sink_percentages = [val / Q_vitr_val * 100 for val in sink_values]

print("\nСтруктура витрат тепла:")
for sink, value, percentage in zip(sink_labels, sink_values, sink_percentages):
