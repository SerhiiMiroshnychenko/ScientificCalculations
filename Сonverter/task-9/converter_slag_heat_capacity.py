...
def c_feo():
    """Теплоємність FeO, кДж/(кг·°С)"""
    return 0.7872

def c_mno():
    """Теплоємність MnO, кДж/(кг·°С)"""
    return 0.7268
...
print(f"     * CaO (0-800°C): {'✗' if T > 800 else '✓'}")
print(f"     * SiO2 (0-1300°C): {'✗' if T > 1300 else '✓'}")
print(f"     * FeO (800-1500°C): {'✓' if 800 <= T <= 1500 else '✗'}")
print(f"     * MnO (800-1500°C): {'✓' if 800 <= T <= 1500 else '✗'}")
