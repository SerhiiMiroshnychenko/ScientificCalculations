...
class Odoo18ContributingScraperStable:
    def __init__(self, start_url):
        # Базові параметри (логіка навігації 1:1 з оригіналом)
    ...
    def extract_content(self, soup, url):
        ...
        # Видаляємо небажані елементи (як в оригіналі)
    ...
    def _process_element(self, element, text_list, parent_tag=None):
        ...
        # Заголовки/параграфи/описові пункти
        ...
        # Списки (як в оригіналі, але рекурсія по дітях не втрачається)
            ...
            # Рекурсія по дітях, щоб не загубити вкладені pre/code/table
            for child in element.children:
                if hasattr(child, 'name'):
                    self._process_element(child, text_list, element.name)

        # Блоки коду — ПОКРАЩЕННЯ
            ...
            # Текст коду збереженням рядків та відступів
            text = None
            if element.name == 'pre':
    ...
    # =========================
    #  Вивід у DOCX (покращено стилі та недопущення дублювання h1)
    # =========================
    ...
    # =========================
    #  Збір структури URL (як в оригіналі)
    # =========================
...
def main():
    ...
    scraper = Odoo18ContributingScraperStable(start_url)
    scraper.scrape()
